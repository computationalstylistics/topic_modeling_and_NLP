...
Before we discuss how to massively analyze all the texts from the subfolder `corpus`, let's take a breath and look at the NLP step alone, as applied to a single text. This is going to be the first text in the said subfolder, namely `act_1_g.txt` (the first chapter of the Acts). We read the text, and then we collapse all the paragraphs to one long string of words:
